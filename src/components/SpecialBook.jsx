      ...
      return (
        <div style={{ backgroundColor: 'rgb(245, 245, 245)' }} className='w-full'>
            ...
            <div className='flex gap-[20px] justify-between'>
              ...
              <Link to='/special'><h1 className='-translate-x-[128%] hover:cursor-pointer border p-[5px] w-[100px] text-center hover:text-blue-800 hover:border-blue-800 rounded-[10px] duration-200'>See All</h1></Link>
            </div>
